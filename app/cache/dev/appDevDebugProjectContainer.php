...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'curl_service' => 'getCurlServiceService',
            ...
            'webservice_user_provider' => 'getWebserviceUserProviderService',
            'webserviceuser_authenticator' => 'getWebserviceuserAuthenticatorService',
        );
        $this->aliases = array(
    ...
    {
        $this->services['assetic.filter.less'] = $instance = new \Assetic\Filter\LessFilter('C:\\Program Files (x86)\\nodejs\\node.exe', array(0 => 'C:\\Program Files (x86)\\nodejs\\node_modules'));
    ...
    /**
     * Gets the 'curl_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\CurlService A AppBundle\Services\CurlService instance.
     */
    protected function getCurlServiceService()
    {
        return $this->services['curl_service'] = new \AppBundle\Services\CurlService();
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3c6779ef18a4b381477140be2645a69644efe9fe3a3f6ead4d0abb9948c809dc');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('WebserviceUserBundle\\Security\\User\\WebserviceUser' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DefaultService()
    {
        ...
        $f = $this->get('webserviceuser_authenticator');
        ...
        $j = new \Symfony\Component\Security\Http\Authentication\SimpleAuthenticationHandler($f, $h, $i, $b);

        $k = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false);

        return $this->services['security.firewall.map.context.default'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('webservice_user_provider'), 1 => $this->get('security.user.provider.concrete.in_memory')), 'default', $b, $c), 2 => new \Symfony\Component\Security\Http\Firewall\SimpleFormAuthenticationListener($a, $g, $this->get('security.authentication.session_strategy'), $d, 'default', $j, $j, array('authenticator' => 'webserviceuser_authenticator', 'check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL, $f), 3 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $g, 'default', $k, $b), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5537023b04b18', $b, $g), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'default', $k, NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DemoSecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.demo_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('webservice_user_provider'), 1 => $this->get('security.user.provider.concrete.in_memory')), 'demo_secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'demo_secured_area', $g, $h, array('check_path' => '_demo_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'demo_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_demo_login', false), NULL, NULL, $b));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\WebserviceUserBundle/Resources/views'), 'WebserviceUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f1043adb43539a306e5c3beec3131e425c795f84');
    }
    ...
    /**
     * Gets the 'webservice_user_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WebserviceUserBundle\Security\User\WebserviceUserProvider A WebserviceUserBundle\Security\User\WebserviceUserProvider instance.
     */
    protected function getWebserviceUserProviderService()
    {
        return $this->services['webservice_user_provider'] = new \WebserviceUserBundle\Security\User\WebserviceUserProvider();
    }

    /**
     * Gets the 'webserviceuser_authenticator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WebserviceUserBundle\Security\WebserviceUserAuthenticator A WebserviceUserBundle\Security\WebserviceUserAuthenticator instance.
     */
    protected function getWebserviceuserAuthenticatorService()
    {
        return $this->services['webserviceuser_authenticator'] = new \WebserviceUserBundle\Security\WebserviceUserAuthenticator($this->get('security.password_encoder'));
    }
    ...
    {
        $a = $this->get('webservice_user_provider');
        $b = $this->get('security.encoder_factory');

        $c = new \Symfony\Component\Security\Core\User\UserChecker();

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'demo_secured_area', $b, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\SimpleAuthenticationProvider($this->get('webserviceuser_authenticator'), $a, 'default'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $c, 'default', $b, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5537023b04b18')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WebserviceUserBundle' => 'WebserviceUserBundle\\WebserviceUserBundle',
            ...
            'locale' => 'en',
            'secret' => 'f1043adb43539a306e5c3beec3131e425c795f84',
            ...
            'kernel.secret' => 'f1043adb43539a306e5c3beec3131e425c795f84',
            ...
            'assetic.filter.less.node' => 'C:\\Program Files (x86)\\nodejs\\node.exe',
