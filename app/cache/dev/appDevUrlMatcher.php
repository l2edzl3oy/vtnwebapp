    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/a')) {
            ...
            if (0 === strpos($pathinfo, '/admin')) {
                ...
                // logic
                if ($pathinfo === '/admin/logic') {
                    return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::logicAction',  '_route' => 'logic',);
                }

                // statistics
                if ($pathinfo === '/admin/statistics') {
                    return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::statisticsAction',  '_route' => 'statistics',);
                }
        ...
        // vtn
        if ($pathinfo === '/vtn') {
            return array (  '_controller' => 'Acme\\DemoBundle\\Controller\\VtnController::getVtnAction',  '_route' => 'vtn',);
        }
